...
#ifdef STEPPERMOTOR
#define MAX_STEPPER_MOT_NUM (APP_SMCA_MAX_NUMBER)
#endif
...
typedef struct
{
   ...
   unsigned short ausHoldRegister[APP_SMCA_HOLD_REG_NUM];

   unsigned short ausInputRegister[APP_SMCA_INPUT_REGS_NUM];
...
#ifdef STEPPERMOTOR
    STEPPER_MOTOR_STRU aStepMotor[MAX_STEPPER_MOT_NUM];
#endif
