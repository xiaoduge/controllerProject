...
DPermissionSetPage::DPermissionSetPage(QObject *parent,CBaseWidget *widget ,MainWindow *wndMain) : CSubPage(parent,widget,wndMain)
{
    creatTitle();
    initUi();
    buildTranslation();
...
void DPermissionSetPage::creatTitle()
{
    CSubPage::creatTitle();
    buildTitles();
    selectTitle(0);
...
void DPermissionSetPage::buildTitles()
{
...
void DPermissionSetPage::switchLanguage()
{
    buildTranslation();
    buildTitles();
...
void DPermissionSetPage::setBackColor()
{
...
void DPermissionSetPage::initUi()
{
    setBackColor();
...
void DPermissionSetPage::on_RfidsaveBtn_clicked()
{
...
void DPermissionSetPage::on_PermissionsaveBtn_clicked()
{
    DISP_MISC_SETTING_STRU  miscParam = gGlobalParam.MiscParam;
...
void DPermissionSetPage::on_chSubAccount_stateChanged(int state)
{
    DISP_MISC_SETTING_STRU  miscParam = gGlobalParam.MiscParam;
    if ((Qt::Checked == state))
    {
...
void DPermissionSetPage::on_QueryBtn_clicked()
{
...
void DPermissionSetPage::on_DisplayAllBtn_clicked()
{
...
void DPermissionSetPage::initRFIDConfigPage()
{
...
void DPermissionSetPage::initInstallPermissionPage()
{
...
void DPermissionSetPage::initSubAccountPage()
{
...
void DPermissionSetPage::initDBTabelModel()
{
...
void DPermissionSetPage::initTabelHeaderData()
{
...
void DPermissionSetPage::on_DeleteOneBtn_clicked()
{
    QString strName = m_pNameLineEdit->text();
...
void DPermissionSetPage::on_DeleteAllBtn_clicked()
{
