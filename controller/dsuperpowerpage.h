#ifndef DSUPERPOWERPAGE_H
#define DSUPERPOWERPAGE_H
...
class DSuperPowerPage : public CSubPage
{
    Q_OBJECT
public:
...
public:
    DSuperPowerPage(QObject *parent = 0,CBaseWidget *widget = 0 , MainWindow *wndMain = 0);
